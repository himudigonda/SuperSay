...
>
> SuperSay remains available as its final, archived `v2.0.1` release. It receives no future features or development. For the supported product experience, download [Voqora](https://github.com/himudigonda/Voqora/releases/latest).
...
1. Download the `SuperSay-2.0.1.dmg` asset from the final release.
...
This repository is archived after `v2.0.1`; pull requests and new feature requests are not accepted. The final source remains available under the [MIT License](./LICENSE). Existing releases remain governed by the licences distributed with those releases.
