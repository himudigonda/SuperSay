...
> SuperSay is retired at `v2.0.3`. It remains usable as a legacy release; [Voqora](https://github.com/himudigonda/Voqora/releases/latest) is the current supported product.
