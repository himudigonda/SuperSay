...
/// Tests for the final legacy telemetry boundary.
final class MetricsServiceTests: XCTestCase {

    func test_telemetryIsExplicitlyAttributedToSuperSay() {
        XCTAssertEqual(MetricsService.telemetryProduct, "supersay")
    }
    ...
    func test_whitelist_rejectsBadValues() {
        ...
        // server-added voice doesn't get dropped client-side. The Voqora API
        // re-validates against its own allowlist. The
