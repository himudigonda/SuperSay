...
/// - The anonymous ID is always included. This final legacy release has no
...
/// - Endpoint: POST /api/voqora/events on himudigonda.me, tagged as the
///   retired SuperSay product so it is never blended into Voqora installs.
final class MetricsService {
    static let shared = MetricsService()
    nonisolated static let telemetryProduct = "supersay"
...
extension MetricsService {
    ...
    enum Props {
        /// Closed whitelist for aggregate product telemetry.
