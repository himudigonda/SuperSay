...
struct SuperSayWindow: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showOnboarding) {
            OnboardingView().environmentObject(onboarding)
        }
    ...
    private var legacyStatusBanner: some View {
        VStack(alignment: .leading, spacing: 8) {
            Label("SuperSay is retired", systemImage: "arrow.right.circle.fill")
    ...
    private static func isVoqoraInstalled() -> Bool {
        let paths = [
            "/Applications/Voqora.app",
            FileManager.default.homeDirectoryForCurrentUser
                .appendingPathComponent("Applications/Voqora.app").path,
        ]
